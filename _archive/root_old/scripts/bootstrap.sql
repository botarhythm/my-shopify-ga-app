...
SELECT * FROM (SELECT NULL::DATE AS date, NULL::VARCHAR AS source, NULL::VARCHAR AS channel,
                      ...
                      0::BIGINT AS purchases, 0.0::DOUBLE AS revenue, 0::BIGINT AS transactions)
WHERE 1=0;
...
SELECT * FROM (SELECT NULL::DATE AS date, NULL::UBIGINT AS order_id, NULL::UBIGINT AS lineitem_id,
                      ...
                      0.0::DOUBLE AS subtotal_price, 0.0::DOUBLE AS total_line_items_price, 0.0::DOUBLE AS total_discounts,
                      0.0::DOUBLE AS total_tax, 0.0::DOUBLE AS total_tip, 0.0::DOUBLE AS shipping_price,
                      0::BIGINT AS shipping_lines, 0::BIGINT AS tax_lines, NULL::VARCHAR AS financial_status,
                      NULL::VARCHAR AS cancelled_at, 0.0::DOUBLE AS refunds_total)
WHERE 1=0;

CREATE TABLE IF NOT EXISTS core_square AS
SELECT * FROM (SELECT NULL::DATE AS date, NULL::VARCHAR AS payment_id, NULL::VARCHAR AS created_at,
                      0.0::DOUBLE AS amount, NULL::VARCHAR AS currency, NULL::VARCHAR AS card_brand,
                      NULL::VARCHAR AS status, NULL::VARCHAR AS receipt_number, NULL::VARCHAR AS order_id,
                      NULL::VARCHAR AS location_id, NULL::VARCHAR AS merchant_id, NULL::VARCHAR AS card_type,
                      NULL::VARCHAR AS card_fingerprint, NULL::VARCHAR AS entry_method, 0.0::DOUBLE AS processing_fee)
WHERE 1=0;
